    ...
    render() {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text text={"Read More..."} font={16} color={"green"} />
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-around", width: '100%', marginVertical: 12 }}>
                    {
                        icons.map((data, index) => <TouchableOpacity key={index} >
